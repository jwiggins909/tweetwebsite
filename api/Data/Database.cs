...
namespace api.Data
{
    public class Database
    {
        ...
        public Database()
        {
            string server = Environment.GetEnvironmentVariable("PA4_database_server");
            string name = Environment.GetEnvironmentVariable("PA4_database_name");
            string port = Environment.GetEnvironmentVariable("PA4_database_port");
            string username = Environment.GetEnvironmentVariable("PA4_database_username");
            string password = Environment.GetEnvironmentVariable("PA4_database_password");
